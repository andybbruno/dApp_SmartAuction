App = {
    // Container of contracts artifacts
    contracts: {},
    ...
    // This function is executed when the html page is going to be loaded.
    // It contains a sequence of async functions executed sequentially
    load: async () => {
    ...
    // This code provides the connection between the wallet and web3
    // MORE INFO: https://medium.com/metamask/https-medium-com-metamask-breaking-change-injecting-web3-7722797916a8 
    loadWeb3: async () => {
    ...
    loadAccount: async () => {
        // Get the current active blockchain account
        App.activeAccount = web3.eth.accounts[0]
    },



    // Load contracts abstractions by using the JSON generated by Truffle
    loadContract: async () => {
    ...
    updateAddress: async () => {
        // Retrieve the addresses from the cookies
...
$(() => {
    ...
    $(window).ready(() => {
        ...
        // Update the aucions list by listening the events from the blockchain
        // Note that this function is executed every 4 seconds.
        var first = true
        ...
        // Mutex to prevent undesired notifications
        Utils.toastUnlocked = true
